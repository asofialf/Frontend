...
export const routes: Routes = [
  {
    path: '',
    redirectTo: '/sign-in', // Redirecciona a la página de sign-up por defecto
    pathMatch: 'full' // Asegura que la redirección solo ocurre cuando la URL coincide exactamente con ''
  },
  {
    path: 'sign-in',
    title: 'Sign In',
